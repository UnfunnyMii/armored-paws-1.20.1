...
public class ArmadilloEntity extends AnimalEntity {
    ...
    private static final double field_48333 = (double)7.0F;
    private static final double field_48334 = (double)2.0F;
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return (PassiveEntity)EntityType.ARMADILLO.create(world);
    }

    public static DefaultAttributeContainer.Builder createArmadilloAttributes() {
        return MobEntity.createMobAttributes().add(EntityAttributes.GENERIC_MAX_HEALTH, (double)12.0F).add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.14);
    }
    ...
    public boolean isEntityThreatening(LivingEntity entity) {
        if (!this.getBoundingBox().expand((double)7.0F, (double)2.0F, (double)7.0F).intersects(entity.getBoundingBox())) {
            return false;
    ...
    public static enum State implements StringIdentifiable {
        ...
        private static final IntFunction<State> INDEX_TO_VALUE = ValueLists.createIdToValueFunction(State::getIndex, values(), OutOfBoundsHandling.ZERO);
        ...
        public static State fromName(String name) {
            return (State)CODEC.byId(name, IDLE);
        }
